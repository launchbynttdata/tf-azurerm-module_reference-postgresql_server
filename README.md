...
| <a name="module_postgresql_server"></a> [postgresql\_server](#module\_postgresql\_server) | git::https://github.com/launchbynttdata/tf-azurerm-module_primitive-postgresql_server.git | feature/autogrow-enabled |
