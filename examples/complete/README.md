...
| <a name="input_auto_grow_enabled"></a> [auto\_grow\_enabled](#input\_auto\_grow\_enabled) | storage auto-grow for PostgreSQL Flexible Server is enabled. | `bool` | `true` | no |
