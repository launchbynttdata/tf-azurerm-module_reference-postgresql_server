...
output "private_dns_zone_id" {
  description = "ID of the private DNS zone associated with the PostgreSQL server"
  value       = module.postgresql_server.private_dns_zone_id
}
...
output "private_endpoint_id" {
  description = "ID of the Private Endpoint (empty if not created)"
